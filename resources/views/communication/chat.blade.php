    ...
    <section id="main" class="notabs">
        <div id="chat_body">
           <div id="chat_left_window">
               @if(isset($chat['left']))
                   {{$header['left']['creator']}}
                    @foreach($chat['left'] as $message)
                        <p class="chat_left_bubble">{{$message['message']}}<br /> <span class="chat_date">{{$message['created_at']}}</span></p>
                    @endforeach
               @endif
            ...
            <div id="chat_right_window">
                @if(isset($chat['right']))
                    ...
                    @foreach($chat['right'] as $message)
                        <p class="chat_right_bubble">{{$message['message']}}<br /> <span class="chat_date">{{$message['created_at']}}</span></p>
                    @endforeach
                @endif
            </div>
</div>
...
<input name="conversation_id" type="hidden" value="{{$header['conversation']}}">
<input name="cid" type="hidden" value="{{Auth::user()->cid}}">
<input name="orgid" type="hidden" value="{{Auth::user()->organization->id}}">
