<nav class="secondary"><ul>
	...
	</ul></nav><div class="products index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('brochure_link'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($product['Product']['long_name']); ?>&nbsp;</td>
		<td><?php echo h($product['Product']['description']); ?>&nbsp;</td>
		<td><?php echo h($product['Product']['brochure_link']); ?>&nbsp;</td>
		<td>
