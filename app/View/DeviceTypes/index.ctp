<nav class="secondary"><ul>
	...
	</ul></nav><div class="deviceTypes index">
	<h2><?php echo __('Device Types'); ?></h2>
	<table cellpadding="0" cellspacing="0">
	<tr>
			<th><?php echo $this->Paginator->sort('id'); ?></th>
			<th><?php echo $this->Paginator->sort('device_type_name'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($deviceType['DeviceType']['device_type_name']); ?>&nbsp;</td>
		<td><?php echo h($deviceType['DeviceType']['description']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($deviceType['User']['id'], array('controller' => 'users', 'action' => 'view', $deviceType['User']['id'])); ?>
		</td>
		<td><?php echo h($deviceType['DeviceType']['created']); ?>&nbsp;</td>
		<td><?php echo h($deviceType['DeviceType']['modified']); ?>&nbsp;</td>
		<td class="actions">
