<nav class="secondary"><ul>
	...
	</ul></nav><div class="originTypes view">
<h2><?php  echo __('Origin Type'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($originType['OriginType']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Short Name'); ?></dt>
		<dd>
			<?php echo h($originType['OriginType']['short_name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Description'); ?></dt>
		<dd>
			<?php echo h($originType['OriginType']['description']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($originType['OriginType']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($originType['OriginType']['modified']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	...
	<?php if (!empty($originType['Prospect'])): ?>
	...
	<?php
		$i = 0;
		foreach ($originType['Prospect'] as $prospect): ?>
		<tr>
