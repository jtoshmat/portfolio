<div class="prospectResponses index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('response_value'); ?></th>
	...
	<?php
	foreach ($prospectResponses as $prospectResponse): ?>
	<tr>
		<td><?php echo h($prospectResponse['ProspectResponse']['id']); ?>&nbsp;</td>
		<td><?php echo h($prospectResponse['ProspectResponse']['response_value']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $prospectResponse['ProspectResponse']['prospect_response_id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $prospectResponse['ProspectResponse']['prospect_response_id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $prospectResponse['ProspectResponse']['prospect_response_id']), null, __('Are you sure you want to delete # %s?', $prospectResponse['ProspectResponse']['prospect_response_id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
