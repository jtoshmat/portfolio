...
<?php echo $this->Form->create('Custom'); ?>
	<fieldset>
		<legend><?php echo __('Edit Custom'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Custom.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Custom.id'))); ?></li>
