var QRF = {
		 ...
		 * Last Modified: December 2, 2013 3:00 PM		 *
		...
		meet_your_agent : function (){
			...
			var longlat1 = $('#map_canvas a[href^="https://maps.google.com/maps"]').attr("href");
			//http://maps.google.com/maps?ll=42.567869,-90.59469&z=10&t=m&hl=en-US
			var longlat1 = longlat1.replace("https://maps.google.com/maps?ll=","");
			...
			//mpdisurl="href" for the normal links
				...
				$.ajax({
					...
					$(xml).find('agent').each(function(){
						...
						if (agentemail==email){
							...
							var url = "<a target=\"_blank\" title=\"Meet Your Agent\" href=\"https://web.amfam.com\" class=\"button agent_website\" id=\"thankyou-agent-website\">Agent Website ></a>";
...
$(document).ready(function(){
	    ...
	    $("#first input:checked").prop("checked", false);
