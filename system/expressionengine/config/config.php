...
$config['install_lock'] = "";
$config['license_number'] = "8584-1409-1583-3974";
$config['debug'] = "1";
$config['cp_url'] = 'https://www.amfambusinessaccelerator.com/admin.php';
$config['doc_url'] = "http://ellislab.com/expressionengine/user-guide/";
$config['is_system_on'] = "y";
$config['allow_extensions'] = 'y';
$config['site_label'] = 'BA';
...
|
*/
$config['encryption_key'] = 'hGQhA6MMoDUnUzSDCyRuEtKbqI1LWBtf45ohKOd9iM7kDscB8cZioY0QVdLdh5i';
