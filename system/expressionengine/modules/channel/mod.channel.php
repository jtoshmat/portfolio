...
class Channel {
 ...
 // -------------------------------------------
// 'channel_entries_sql_where' hook.
//  by SOLSPACE
//
if ($this->EE->extensions->active_hook('channel_entries_sql_where') === TRUE)
{
    $sql = $this->EE->extensions->universal_call('channel_entries_sql_where', $sql, $this);
